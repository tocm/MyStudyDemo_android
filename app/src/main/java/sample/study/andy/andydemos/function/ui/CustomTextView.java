package sample.study.andy.andydemos.function.ui;
...
/**
 * Created by Andy.chen on 2016/7/29.
 */
public class CustomTextView extends TextView {
    ...
    public CustomTextView(Context context, AttributeSet set)
    {
        ...
        int textcolor = typedArray.getColor(R.styleable.CYTextView_textColor, 0xff0000);
