package sample.study.andy.andydemos.function.key;

import android.util.SparseIntArray;

import static android.view.KeyCharacterMap.COMBINING_ACCENT;

/**
 * Created by Andy.chen on 2017/1/13.
 */
...
public class KeyMapping {
  ...
  */
    public static final int ACUTE = '\u00B4' << 16;
    public static final int GRAVE = '`' << 16;
    public static final int CIRCUMFLEX = '^' << 16;
    public static final int TILDE = '~' << 16;
    public static final int UMLAUT = '\u00A8' << 16;
