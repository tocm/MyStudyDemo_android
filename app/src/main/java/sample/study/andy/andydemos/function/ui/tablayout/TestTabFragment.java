 ...
 * {@link TestTabFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link TestTabFragment#newInstance} factory method to
...
public class TestTabFragment extends Fragment {
     ...
     * @return A new instance of fragment TestTabFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TestTabFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for (int i=0;i<3;i++) {
            ...
            categoryEntity.setName("Category_"+i);
            mFragmentAdapter.addItem(categoryEntity);
            mTabLayout.addTab(mTabLayout.newTab());
        }
        Log.d(TAG," onCreateView bindCategoryData ");
        bindCategoryData();
        return view;
    }
